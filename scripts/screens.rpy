...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            imagebutton idle "gui/auto.png" selected_idle "gui/auto_selected.png" action Preference("auto-forward", "toggle")
            imagebutton idle "gui/menu.png" action ShowMenu('preferences')
